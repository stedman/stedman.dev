...
To the site root, add an empty `.nojekyll` file to [disable the default Jekyll build](https://help.github.com/en/github/working-with-github-pages/about-github-pages#static-site-generators).

```shell
touch .nojekyll
```

To the site root, add a `.eleventy.js` config file with the following contents (for more details, see [Eleventy configuration docs](https://www.11ty.dev/docs/config/)):
...
If you haven't already set up an apex domain (e.g., `example.com`) for this repo, then you will need to add it. Follow the [GitHub instructions for managing a custom domain](https://help.github.com/en/github/working-with-github-pages/managing-a-custom-domain-for-your-github-pages-site).
